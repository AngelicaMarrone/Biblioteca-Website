...
<head>
		...
		<title>Successo_registrazione</title>
...
<body>
			...
			<div class="content"> <h2>Registrazione avvenuta con successo!</h2>
			<p>Se non &egrave collegato nessun account, effettua il <a href="login.php">login</a> per accedere e visualizzare i libri disponibili;</p>
			<p>Altrimenti, effettua prima il <a href="logout.php">logout</a> dall'account attuale.</p>
           </div>
