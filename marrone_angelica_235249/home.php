...
<body>
			...
			<div class="content"><h2>Benvenuto in TO.Biblio!</h2>
				<p><a href="new.php">Registrati</a> o effettua il <a href="login.php">login</a> per accedere. </p>
				<p>Una volta effettuato l'accesso potrai aggiungere e togliere libri dal tuo scaffale, mantenendone un massimo di tre per volta.</p>
				<p>Senza effettuare l'accesso, potrai comunque vedere il numero di libri esistenti in biblioteca e il numero di quelli disponibili per il prestito.<p>
			</div>	
